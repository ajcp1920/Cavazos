...
<head>
 ...
 <div class="modal fade" id="modalSalida" role="dialog">
        ...
        <form class="form">
            ...
            <p class="uno"></p><h1>Datos para envio de Paquetes de Mercado Libre</h1></p>
        ...
        <div class="mb-3 form-check">
            ...
            <label class="form-check-label" for="terminos">Acepto los terminos y condiciones</label> <link href="">
        </div>
